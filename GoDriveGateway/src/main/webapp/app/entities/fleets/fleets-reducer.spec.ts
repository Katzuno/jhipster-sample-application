...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fleets.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLEETS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLEETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLEETS actions', async () => {
      const expectedActions = [
        {
